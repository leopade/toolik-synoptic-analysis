...
def extract_peaks(input_file, day_dir, channel):
    ...
    out2500 = open(
        os.path.join(day_dir, "peak_2500_ch" + str(channel) + "_" + os.path.basename(day_dir) + ".dat"),
        "w"
    )
    out3330 = open(
        os.path.join(day_dir, "peak_3330_ch" + str(channel) + "_" + os.path.basename(day_dir) + ".dat"),
        "w"
    )
    out4996 = open(
        os.path.join(day_dir, "peak_4996_ch" + str(channel) + "_" + os.path.basename(day_dir) + ".dat"),
        "w"
    )
